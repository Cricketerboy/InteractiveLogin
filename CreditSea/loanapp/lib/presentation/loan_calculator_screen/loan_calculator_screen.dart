...
class LoanCalculatorScreen extends GetWidget<LoanCalculatorController> {
    ...
    return CustomElevatedButton(
      buttonStyle: ElevatedButton.styleFrom(
        ...
        shape: RoundedRectangleBorder(
          ...
          side: BorderSide(
              color: const Color.fromARGB(255, 221, 218, 218)), // Blue border
        ),
      ),
      height: 30,
      width: 100,
      text: "₹ 30,000".tr,
      //leftIcon: CustomImageView(imagePath: ImageConstant.imgMdicurrencyrupee, height: 16, width: 16),
  ...
  Widget _buildSummarySection() {
    return Container(
      ...
      child: Column(
        children: [
          _buildTotalPayableRow("Principle Amount".tr, "₹1,00,000".tr),
          SizedBox(height: 10.v),
          _buildTotalPayableRow("Interest".tr, "1%".tr),
          SizedBox(height: 10.v),
          _buildTotalPayableRow("Total Payable".tr, "₹2000".tr),
        ],
      ),
    );
  }

  Widget _buildTotalPayableRow(String label, String value) {
    return Row(
      mainAxisAlignment: MainAxisAlignment.spaceBetween,
      children: [
        Text(label,
